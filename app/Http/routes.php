...
Route::group(['middleware' => ['web']], function () {
    ...
    Route::get('/book/{slug}', ['uses' => 'StoreController@view', 'as' => 'store.view']);
    Route::get('/category/{id}', ['uses' => 'StoreController@category', 'as' => 'store.category']);
    Route::get('/search', ['uses' => 'StoreController@search', 'as' => 'store.search']);

    Route::group(['middleware' => ['auth']], function () {
        Route::get('/checkout/{id}', ['uses' => 'StoreController@checkout', 'as' => 'store.checkout']);
        Route::post('/checkout/process/{id}', ['uses' => 'StoreController@process', 'as' => 'store.process']);
        Route::get('/orders', ['uses' => 'StoreController@orders', 'as' => 'store.orders']);
        Route::get('/download/{id}', ['uses' => 'StoreController@download', 'as' => 'store.download']);
    });
...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'middleware' => 'web'], function () {
    ...
    Route::get('books/download/{id}', ['as' => 'books.download', 'uses' => 'Admin\BooksController@download']);
